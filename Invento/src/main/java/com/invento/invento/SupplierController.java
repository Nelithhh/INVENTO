...
public class SupplierController implements Initializable {
    ...
    private void Add(ActionEvent event){
        ...
        Connection connectDB = connectNow.getConnection();
        String sql="INSERT INTO supplier(contact, name, address, email, userEmail) VALUES (?, ?, ?, ?, ?)";
        try{
            PreparedStatement preparedStatement = connectDB.prepareStatement(sql);
            ...
            alert.setTitle("Supplier Registration");
            alert.setHeaderText("Supplier Registration");
            alert.setContentText("New Supplier Added Successfully!");
            alert.showAndWait();
    ...
    private void Edit(ActionEvent event){
        Connection connectDB = connectNow.getConnection();
        String sql="UPDATE supplier SET contact=?, name=?, address=?, email=? WHERE contact=? AND userEmail=?";
        try{
            PreparedStatement preparedStatement = connectDB.prepareStatement(sql);
            preparedStatement.setString(1,txtPhoneNumber.getText());
            preparedStatement.setString(2,txtFullName.getText());
            ...
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Supplier Updation");
            alert.setHeaderText("Supplier Updation");
    ...
    private void Delete(ActionEvent event){
        Connection connectDB = connectNow.getConnection();
        String sql = "DELETE FROM supplier WHERE contact=? AND userEmail=?";
        try {
            PreparedStatement preparedStatement = connectDB.prepareStatement(sql);
            preparedStatement.setString(1, txtPhoneNumber.getText());
            ...
            alert.setHeaderText("Supplier Deletion");
            alert.setContentText("Supplier Details Deleted Successfully!");
            alert.showAndWait();
